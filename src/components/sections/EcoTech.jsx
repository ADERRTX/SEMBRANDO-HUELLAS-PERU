      ...
      >
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
            <h4 className="font-bold text-gray-900 dark:text-white mb-3">{t('ecotech.environmental_impact')}</h4>
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 mt-1">{t('ecotech.period')}</div>
              </div>
              <div>
                <motion.div
                  className="text-2xl font-bold text-green-600 dark:text-green-400"
                ...
                <div className="text-xs text-gray-500 mt-1">{t('ecotech.region')}</div>
              </div>
            </div>
          </div>
        </div>
