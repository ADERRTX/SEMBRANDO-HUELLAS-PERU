    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="relative">
          <button
            onClick={prev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center text-gray-600 hover:text-green-600 transition-colors"
          >
          ...
          <button
            onClick={next}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center text-gray-600 hover:text-green-600 transition-colors"
          >
          ...
          <div className="overflow-hidden px-4">
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                <p className="text-gray-500 text-sm">{d(`testimonialsData.${currentIndex}.role`) || testimonial.role}</p>
              </motion.div>
            </AnimatePresence>
          </div>
